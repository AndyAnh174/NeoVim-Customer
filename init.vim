" .----------------.  .-----------------. .----------------.  .----------------.  .----------------.  .-----------------. .----------------. 
"| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
"| |      __      | || | ____  _____  | || |  ________    | || |  ____  ____  | || |      __      | || | ____  _____  | || |  ____  ____  | |
"| |     /  \     | || ||_   \|_   _| | || | |_   ___ `.  | || | |_  _||_  _| | || |     /  \     | || ||_   \|_   _| | || | |_   ||   _| | |
"| |    / /\ \    | || |  |   \ | |   | || |   | |   `. \ | || |   \ \  / /   | || |    / /\ \    | || |  |   \ | |   | || |   | |__| |   | |
"| |   / ____ \   | || |  | |\ \| |   | || |   | |    | | | || |    \ \/ /    | || |   / ____ \   | || |  | |\ \| |   | || |   |  __  |   | |
"| | _/ /    \ \_ | || | _| |_\   |_  | || |  _| |___.' / | || |    _|  |_    | || | _/ /    \ \_ | || | _| |_\   |_  | || |  _| |  | |_  | |
"| ||____|  |____|| || ||_____|\____| | || | |________.'  | || |   |______|   | || ||____|  |____|| || ||_____|\____| | || | |____||____| | |
"| |              | || |              | || |              | || |              | || |              | || |              | || |              | |
"| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
" '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
" Vim customized by AndyAnh 
"
...
" Status bar
  ...
  Plug 'nvim-tree/nvim-web-devicons'  " Để hiển thị biểu tượn
" Terminal
...
let g:copilot#key = 'ctrl+space'
inoremap <C-J> <Plug>(copilot-accept)
